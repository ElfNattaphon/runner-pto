...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const h = computed(() => {
      var _a;
      return Math.floor(((_a = props.modelValue) != null ? _a : 0) / 3600);
    });
    const m = computed(() => {
      var _a;
      return Math.floor(((_a = props.modelValue) != null ? _a : 0) % 3600 / 60);
    });
    const s = computed(() => {
      var _a;
      return Math.floor(((_a = props.modelValue) != null ? _a : 0) % 60);
    });
...
//# sourceMappingURL=TimeHMSInput-DArq7jMJ.mjs.map
